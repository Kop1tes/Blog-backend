...
export const getOne = async (req, res) => {     //создаем переменную получения всех статей
    try {
        ...
        // PostModel.findOneAndUpdate(     //находим одну статью чтобы обновить
        //     {
        //         _id: postId,    //ищем статью по id
        //     },
        //     {
        //         $inc: {viewsCount: 1},      //обновляем количество просмотров статьи
        //     },
        //     {
        //         returnDocument: 'after',       //обновляем статью и ее возвращаем
        //     },
        //     (err, doc) => {        //передаем функцию которая покажет была ли ошибка или пришел документ
        //         if (err) {      //если была ошибка то оповести об этом
        //             console.log(err)
        ...
        //         if (!doc) {     //если не вернулся документ то оповести об этом
        //             return res.status(404).json({
        //                 message: 'Статья не найдена',
        //             });
        //         }
        //         res.json(doc);      //если ошибок не было то возвращается документ
        //     }
        // )
...
// export const remove = async (req, res) => {     //создаем переменную удаления статьи
//     try {
//         const postId = req.params.id;       //запсываю в переменную найденное id
...
//              if (!doc) {
//                 return res.status(404).json({
//                     message: 'Не удалось удалить статьюСтатья не найдена'
//                 })
//             }
...
//         console.log(error)
//         res.status(500).json({
//             message: 'Не удалось получить статью',       //если произошла ошибка то оповести об этом
//         })
//     }
// }
